    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            inputs.forEach(function(input) {
                if (input.hasAttribute('required') || input.getAttribute('name') === 'email' || input.getAttribute('name') === 'name') {
        ...
        contactForm.addEventListener('blur', function(e) {
            const input = e.target;
            if (input.tagName === 'INPUT' || input.tagName === 'TEXTAREA' || input.tagName === 'SELECT') {
                if (input.hasAttribute('required') || input.getAttribute('name') === 'email') {
                    validateField(input);
                }
            }
        }, true);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e9bb44de-3bad-48f5-8ae2-7c717511366a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e9bb44de-3bad-48f5-8ae2-7c717511366a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e9bb44de-3bad-48f5-8ae2-7c717511366a';
